...
func TestIsSLSATrackLevel(t *testing.T) {
	testCases := []struct {
		...
		{"valid source level 0", "SLSA_SOURCE_LEVEL_0", true},
		{"valid source level 1", "SLSA_SOURCE_LEVEL_1", true},
		{"valid source level 2", "SLSA_SOURCE_LEVEL_2", true},
		{"valid source level 3", "SLSA_SOURCE_LEVEL_3", true},
		{"invalid - higher level number", "SLSA_BUILD_LEVEL_4", false},
		{"invalid - source level too high", "SLSA_SOURCE_LEVEL_4", false},
